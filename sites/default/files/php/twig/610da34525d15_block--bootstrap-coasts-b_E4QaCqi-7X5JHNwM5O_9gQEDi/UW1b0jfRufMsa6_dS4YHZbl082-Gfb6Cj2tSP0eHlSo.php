...
/* themes/bootstrap_coasts/templates/block--bootstrap-coasts-branding.html.twig */
class __TwigTemplate_02bf6f6f3880a30cd26fccb5a9d0d4f6d156ddb95014aeeab4bbc84db48c9da1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("block--bare.html.twig", "themes/bootstrap_coasts/templates/block--bootstrap-coasts-branding.html.twig", 1);
  ...
  ";
        ...
        if (($context["site_name"] ?? null)) {
            // line 25
            echo "    <a class=\"name navbar-brand col-md-12\" href=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->getPath("<front>"));
            echo "\" title=\"";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Home"));
            echo "\" rel=\"home\">";
  ...
  ";
    ...
    {
        return "themes/bootstrap_coasts/templates/block--bootstrap-coasts-branding.html.twig";
    }
...
{% block content %}
  ...
  {% endif %}
  {% if site_name %}
    <a class=\"name navbar-brand col-md-12\" href=\"{{ path('<front>') }}\" title=\"{{ 'Home'|t }}\" rel=\"home\">{{ site_name }}</a>
  {% endif %}
  {% if site_slogan %}
    <p class=\"navbar-text\">{{ site_slogan }}</p>
  {% endif %}
{% endblock %}
", "themes/bootstrap_coasts/templates/block--bootstrap-coasts-branding.html.twig", "/home/rebecc25/public_html/themes/bootstrap_coasts/templates/block--bootstrap-coasts-branding.html.twig");
    }
