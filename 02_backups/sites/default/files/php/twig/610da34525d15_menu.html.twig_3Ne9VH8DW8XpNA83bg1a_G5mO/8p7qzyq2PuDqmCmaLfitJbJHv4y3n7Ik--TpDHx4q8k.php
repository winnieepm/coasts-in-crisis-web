...
/* menu.html.twig */
class __TwigTemplate_13cd1f6c684ec46c7925433017b9f1161b433fcb019298f54d54ec11cbc4d549 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["loop"], "last", [], "any", false, false, true, 34)) ? ("last") : (""))];
        ...
        ";
                    // line 38
                    $context["link_title"] = ($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 38), 38, $this->source) . "        |");
                    // line 39
                    echo "        ";
...
", "menu.html.twig", "themes/bootstrap_coasts/templates/menu.html.twig");
    }
